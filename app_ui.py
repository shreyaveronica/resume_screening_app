...
category_input = st.sidebar.selectbox(
    "🎯 Select Target Role",
    ["BANKING", "HR", "INFORMATION-TECHNOLOGY", "FINANCE", "ACCOUNTANT", "TEACHER", "CHEF", "ADVOCATE", "CONSULTANT", "AGRICULTURE", "ARTS", "AUTOMOBILE", "AVIATION", "BPO", "BUSINESS-DEVELOPMENT", "CONSTRUCTION", "DESIGNER", "DIGITAL-MEDIA", "ENGINEERING", "HEALTHCARE", "PUBLIC-RELATIONS", "SALES"]
)
...
if run_button:
    ...
    with st.spinner("🔄 Processing resumes..."):
        ...
        # MODEL
        target_category = category_input
