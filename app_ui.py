...
category_input = st.sidebar.selectbox(
    "🎯 Select Target Role",
    ["BANKING", "HR", "INFORMATION-TECHNOLOGY", "FINANCE", "ACCOUNTANT", "TEACHER", "CHEF", "ADVOCATE", "CONSULTANT", "AGRICULTURE", "ARTS", "AVIATION", "BUSINESS-DEVELOPMENT", "CONSTRUCTION", "DESIGNER", "DIGITAL-MEDIA", "ENGINEERING", "HEALTHCARE", "PUBLIC-RELATIONS", "SALES"]
)
